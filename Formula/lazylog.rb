class Lazylog < Formula
  ...
  url "https://github.com/tr-nc/lazylog/releases/download/v0.10.0/lazylog-macos.tar.gz"
  ...
  sha256 "313594b837862af47cd65f5592e1b8f912196d52649805bbe4b8051cc963b370"
